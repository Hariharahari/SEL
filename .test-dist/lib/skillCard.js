...
exports.SKILL_ID_PATTERN = void 0;
exports.normalizeSkillUploadPayload = normalizeSkillUploadPayload;
exports.wrapSkillCard = wrapSkillCard;
exports.buildSkillPayloadFromJsonText = buildSkillPayloadFromJsonText;
exports.buildSkillPayloadFromFormData = buildSkillPayloadFromFormData;
...
function normalizeSkillUploadPayload(payload) {
    ...
    if (!exports.SKILL_ID_PATTERN.test(raw.starterkit_id.trim())) {
        throw new Error('Skill ID must use lowercase letters, numbers, and hyphens only. Spaces are not allowed.');
    }
...
function wrapSkillCard(skillCard) {
    return { skill_card: skillCard };
}
function buildSkillPayloadFromJsonText(jsonText) {
    try {
...
function buildSkillPayloadFromFormData(formData) {
...
//# sourceMappingURL=skillCard.js.map