...
**Technology:** PostgreSQL, Azure, Docker, Redis, Kubernetes, Spring Boot
...
3. Verify all required technologies available: PostgreSQL, Azure, Docker, Redis, Kubernetes, Spring Boot
...
- **Supported Technologies:** PostgreSQL, Azure, Docker, Redis, Kubernetes, Spring Boot
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.cd98a26b.v1
