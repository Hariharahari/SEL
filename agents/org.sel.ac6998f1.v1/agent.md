...
**Technology:** Django, NestJS, JavaScript, Ember, Java

**Invocation Examples:**
- `Dynamic Analysis Specialist` *(reads configuration from project)*
- `Dynamic Analysis Specialist (custom configuration)` *(uses provided config)*
- `Dynamic Analysis Specialist (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "DynamicAnalysisSpecialist"
...
3. Verify all required technologies available: Django, NestJS, JavaScript, Ember, Java
...
- **Supported Technologies:** Django, NestJS, JavaScript, Ember, Java
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.ac6998f1.v1
