...
**Technology:** TensorFlow, Python, Kubernetes, Redis, React, TypeScript, Git

**Invocation Examples:**
- `Test Data Generation Specialist` *(reads configuration from project)*
- `Test Data Generation Specialist (custom configuration)` *(uses provided config)*
- `Test Data Generation Specialist (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "TestDataGenerationSpecialist"
...
3. Verify all required technologies available: TensorFlow, Python, Kubernetes, Redis, React, TypeScript, Git
...
- **Supported Technologies:** TensorFlow, Python, Kubernetes, Redis, React, TypeScript, Git
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.7953c510.v1
