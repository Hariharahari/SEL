...
**Technology:** Java, Terraform, scikit-learn, Flask, MongoDB, Elasticsearch, Go, GitHub

**Invocation Examples:**
- `Code Generation Specialist` *(reads configuration from project)*
- `Code Generation Specialist (custom configuration)` *(uses provided config)*
- `Code Generation Specialist (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: Java, Terraform, scikit-learn, Flask, MongoDB, Elasticsearch, Go, GitHub
...
- **Supported Technologies:** Java, Terraform, scikit-learn, Flask, MongoDB, Elasticsearch, Go, GitHub
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.2590fe9c.v1
