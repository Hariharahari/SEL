# Vulnerability Review Generator
...
**Technology:** AWS, PostgreSQL, Terraform, JavaScript, Rust, GitHub, Git, Spring Boot

**Invocation Examples:**
- `Vulnerability Review Generator` *(reads configuration from project)*
- `Vulnerability Review Generator (custom configuration)` *(uses provided config)*
- `Vulnerability Review Generator (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "VulnerabilityReviewGenerator"
  description: "Generates high-quality vulnerability review automatically"
  version: "5.0.16"
  status: "beta"
```
...
3. Verify all required technologies available: AWS, PostgreSQL, Terraform, JavaScript, Rust, GitHub, Git, Spring Boot
...
- **Supported Technologies:** AWS, PostgreSQL, Terraform, JavaScript, Rust, GitHub, Git, Spring Boot
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.e63daf88.v1

---

*Agent auto-generated by NVIDIA Agent Generator*  
*Agent ID: unknown*  
*Generated: 2026-04-19 13:22:08*
