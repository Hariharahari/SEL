...
**Technology:** Spring Boot, Python, JavaScript, Docker, Terraform, AWS, GCP, Git

**Invocation Examples:**
- `Data Modeling Specialist` *(reads configuration from project)*
- `Data Modeling Specialist (custom configuration)` *(uses provided config)*
- `Data Modeling Specialist (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: Spring Boot, Python, JavaScript, Docker, Terraform, AWS, GCP, Git
...
- **Supported Technologies:** Spring Boot, Python, JavaScript, Docker, Terraform, AWS, GCP, Git
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.8ecd21df.v1

---

*Agent auto-generated by NVIDIA Agent Generator*  
*Agent ID: unknown*  
*Generated: 2026-04-14 14:22:08*
