# Monitoring Integration Analyzer
...
**Technology:** NestJS, GCP, Docker, FastAPI, Ansible, Next.js, Express.js

**Invocation Examples:**
- `Monitoring Integration Analyzer` *(reads configuration from project)*
- `Monitoring Integration Analyzer (custom configuration)` *(uses provided config)*
- `Monitoring Integration Analyzer (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "MonitoringIntegrationAnalyzer"
  description: "Automates monitoring integration with real-time insights"
  version: "2.5.0"
  status: "stable"
```
...
3. Verify all required technologies available: NestJS, GCP, Docker, FastAPI, Ansible, Next.js, Express.js
...
- **Supported Technologies:** NestJS, GCP, Docker, FastAPI, Ansible, Next.js, Express.js
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.e614aef2.v1
