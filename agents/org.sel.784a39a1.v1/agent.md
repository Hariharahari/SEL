...
**Technology:** NestJS, Terraform, GitLab, PostgreSQL, MongoDB, scikit-learn

**Invocation Examples:**
- `Api Design Optimizer` *(reads configuration from project)*
- `Api Design Optimizer (custom configuration)` *(uses provided config)*
- `Api Design Optimizer (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: NestJS, Terraform, GitLab, PostgreSQL, MongoDB, scikit-learn
...
- **Supported Technologies:** NestJS, Terraform, GitLab, PostgreSQL, MongoDB, scikit-learn
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.784a39a1.v1

---

*Agent auto-generated by NVIDIA Agent Generator*  
*Agent ID: unknown*  
*Generated: 2026-04-13 19:22:04*
