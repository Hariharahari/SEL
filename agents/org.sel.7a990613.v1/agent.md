...
**Technology:** GCP, Terraform, Spring Boot, scikit-learn, Svelte, FastAPI, Flask

**Invocation Examples:**
- `Migration Specialist` *(reads configuration from project)*
- `Migration Specialist (custom configuration)` *(uses provided config)*
- `Migration Specialist (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: GCP, Terraform, Spring Boot, scikit-learn, Svelte, FastAPI, Flask
...
- **Supported Technologies:** GCP, Terraform, Spring Boot, scikit-learn, Svelte, FastAPI, Flask
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.7a990613.v1

---

*Agent auto-generated by NVIDIA Agent Generator*  
*Agent ID: unknown*  
*Generated: 2026-04-19 05:22:08*
