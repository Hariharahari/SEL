# Code Smell Detection Generator
...
**Technology:** Ansible, Spring Boot, Python, Express.js, Kubernetes, MongoDB, PostgreSQL

**Invocation Examples:**
- `Code Smell Detection Generator` *(reads configuration from project)*
- `Code Smell Detection Generator (custom configuration)` *(uses provided config)*
- `Code Smell Detection Generator (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "CodeSmellDetectionGenerator"
  description: "Monitors and tracks code smell detection metrics"
  version: "3.2.8"
  status: "stable"
```
...
3. Verify all required technologies available: Ansible, Spring Boot, Python, Express.js, Kubernetes, MongoDB, PostgreSQL
...
- **Supported Technologies:** Ansible, Spring Boot, Python, Express.js, Kubernetes, MongoDB, PostgreSQL
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.52a814e8.v1

---

*Agent auto-generated by NVIDIA Agent Generator*  
*Agent ID: unknown*  
*Generated: 2026-04-15 04:21:12*
