...
**Technology:** Vue, JavaScript, Express.js, Elasticsearch, Git, Spring Boot

**Invocation Examples:**
- `Migration Monitor` *(reads configuration from project)*
- `Migration Monitor (custom configuration)` *(uses provided config)*
- `Migration Monitor (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: Vue, JavaScript, Express.js, Elasticsearch, Git, Spring Boot
...
- **Supported Technologies:** Vue, JavaScript, Express.js, Elasticsearch, Git, Spring Boot
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.2634219e.v1
