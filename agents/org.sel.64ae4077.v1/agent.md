...
**Technology:** JavaScript, Spring Boot, Docker, Next.js, Elasticsearch, Django, Ember, Python

**Invocation Examples:**
- `Vulnerability Review Specialist` *(reads configuration from project)*
- `Vulnerability Review Specialist (custom configuration)` *(uses provided config)*
- `Vulnerability Review Specialist (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "VulnerabilityReviewSpecialist"
  description: "Analyzes and improves vulnerability review quality"
  version: "1.3.1"
  status: "stable"
```
...
3. Verify all required technologies available: JavaScript, Spring Boot, Docker, Next.js, Elasticsearch, Django, Ember, Python
...
- **Supported Technologies:** JavaScript, Spring Boot, Docker, Next.js, Elasticsearch, Django, Ember, Python
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.64ae4077.v1
