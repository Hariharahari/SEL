...
**Technology:** Next.js, JavaScript, Express.js, Java, Terraform, Spring Boot, MongoDB, Python

**Invocation Examples:**
- `Refactoring Specialist` *(reads configuration from project)*
- `Refactoring Specialist (custom configuration)` *(uses provided config)*
- `Refactoring Specialist (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: Next.js, JavaScript, Express.js, Java, Terraform, Spring Boot, MongoDB, Python
...
- **Supported Technologies:** Next.js, JavaScript, Express.js, Java, Terraform, Spring Boot, MongoDB, Python
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.a4b451a5.v1

---

*Agent auto-generated by NVIDIA Agent Generator*  
*Agent ID: unknown*  
*Generated: 2026-04-14 05:22:09*
