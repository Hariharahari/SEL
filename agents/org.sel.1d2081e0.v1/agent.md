...
**Technology:** Elasticsearch, Docker, Git, Angular, Java, scikit-learn, Next.js, Spring Boot

**Invocation Examples:**
- `Migration Analyzer` *(reads configuration from project)*
- `Migration Analyzer (custom configuration)` *(uses provided config)*
- `Migration Analyzer (full execution mode)` *(generates all components)*
...
project:
  ...
  description: "Generates high-quality migration automatically"
  version: "4.4.15"
  status: "beta"
```
...
3. Verify all required technologies available: Elasticsearch, Docker, Git, Angular, Java, scikit-learn, Next.js, Spring Boot
...
- **Supported Technologies:** Elasticsearch, Docker, Git, Angular, Java, scikit-learn, Next.js, Spring Boot
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.1d2081e0.v1
