...
**Technology:** Git, Keras, Elasticsearch, Rust, Express.js, Ember, Vue

**Invocation Examples:**
- `Monitoring Integration Specialist` *(reads configuration from project)*
- `Monitoring Integration Specialist (custom configuration)` *(uses provided config)*
- `Monitoring Integration Specialist (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "MonitoringIntegrationSpecialist"
...
3. Verify all required technologies available: Git, Keras, Elasticsearch, Rust, Express.js, Ember, Vue
...
- **Supported Technologies:** Git, Keras, Elasticsearch, Rust, Express.js, Ember, Vue
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.057ce21f.v1
