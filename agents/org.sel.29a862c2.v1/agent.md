...
**Technology:** MongoDB, JavaScript, TypeScript, React, Express.js, Kubernetes, Docker, AWS

**Invocation Examples:**
- `Security Review Specialist` *(reads configuration from project)*
- `Security Review Specialist (custom configuration)` *(uses provided config)*
- `Security Review Specialist (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: MongoDB, JavaScript, TypeScript, React, Express.js, Kubernetes, Docker, AWS
...
- **Supported Technologies:** MongoDB, JavaScript, TypeScript, React, Express.js, Kubernetes, Docker, AWS
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.29a862c2.v1

---

*Agent auto-generated by NVIDIA Agent Generator*  
*Agent ID: unknown*  
*Generated: 2026-04-17 20:22:08*
