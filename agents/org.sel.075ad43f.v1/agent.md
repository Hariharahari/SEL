...
**Technology:** TypeScript, AWS, GCP, Spring Boot, MongoDB, NestJS, Angular, Flask

**Invocation Examples:**
- `Reverse Engineering Specialist` *(reads configuration from project)*
- `Reverse Engineering Specialist (custom configuration)` *(uses provided config)*
- `Reverse Engineering Specialist (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "ReverseEngineeringSpecialist"
  description: "Analyzes and improves reverse engineering quality"
  version: "4.9.14"
  status: "beta"
```
...
3. Verify all required technologies available: TypeScript, AWS, GCP, Spring Boot, MongoDB, NestJS, Angular, Flask
...
- **Supported Technologies:** TypeScript, AWS, GCP, Spring Boot, MongoDB, NestJS, Angular, Flask
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.075ad43f.v1

---

*Agent auto-generated by NVIDIA Agent Generator*  
*Agent ID: unknown*  
*Generated: 2026-04-19 20:22:07*
