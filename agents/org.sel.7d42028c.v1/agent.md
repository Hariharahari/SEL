...
**Technology:** GCP, MongoDB, AWS, PostgreSQL, Ember

**Invocation Examples:**
- `Dynamic Analysis Monitor` *(reads configuration from project)*
- `Dynamic Analysis Monitor (custom configuration)` *(uses provided config)*
- `Dynamic Analysis Monitor (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: GCP, MongoDB, AWS, PostgreSQL, Ember
...
- **Supported Technologies:** GCP, MongoDB, AWS, PostgreSQL, Ember
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.7d42028c.v1

---

*Agent auto-generated by NVIDIA Agent Generator*  
*Agent ID: unknown*  
*Generated: 2026-04-18 06:22:06*
