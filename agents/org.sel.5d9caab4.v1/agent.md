...
**Technology:** Elasticsearch, PyTorch, Ember, scikit-learn, Django, Java

**Invocation Examples:**
- `Advanced Performance Optimization` *(reads configuration from project)*
- `Advanced Performance Optimization (custom configuration)` *(uses provided config)*
- `Advanced Performance Optimization (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "AdvancedPerformanceOptimization"
...
3. Verify all required technologies available: Elasticsearch, PyTorch, Ember, scikit-learn, Django, Java
...
- **Supported Technologies:** Elasticsearch, PyTorch, Ember, scikit-learn, Django, Java
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.5d9caab4.v1
