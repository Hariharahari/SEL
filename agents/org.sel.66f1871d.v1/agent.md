...
**Technology:** JavaScript, GitHub, Svelte, Elasticsearch, scikit-learn

**Invocation Examples:**
- `Advanced Code Smell Detection` *(reads configuration from project)*
- `Advanced Code Smell Detection (custom configuration)` *(uses provided config)*
- `Advanced Code Smell Detection (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "AdvancedCodeSmellDetection"
...
3. Verify all required technologies available: JavaScript, GitHub, Svelte, Elasticsearch, scikit-learn
...
- **Supported Technologies:** JavaScript, GitHub, Svelte, Elasticsearch, scikit-learn
...
**GitHub:** https://github.com/Hariharahari/Agents/tree/main/org.sel.66f1871d.v1
